...
public class UserController {
  ...
  /** Holt einen User nach ID (nur Admin oder der User selbst) */
  @GetMapping("/{id}")
  @PreAuthorize("hasAuthority('USER_READ') or @userPermissionEvaluator.isOwner(authentication.principal.user, #id)")
  ...
  /** Aktualisiert einen User (nur Admin oder der User selbst) */
  @PutMapping("/{id}")
  @PreAuthorize("hasAuthority('USER_MODIFY') or @userPermissionEvaluator.isOwner(authentication.principal.user, #id)")
